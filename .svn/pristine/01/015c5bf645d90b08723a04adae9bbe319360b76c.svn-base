...
import cn.epi.common.task.QuartzJobFactory;
import cn.epi.common.task.QuartzJobFactoryDisallowConcurrentExecution;
import cn.epi.sys.dao.ScheduleJobDao;
import cn.epi.sys.entity.ScheduleJob;
