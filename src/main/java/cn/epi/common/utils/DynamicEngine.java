...
public class DynamicEngine {
     ...
     */
    public Map<String, String> javaCodeToObject(String fullClassName, String javaCode,Map map,PortEntity port,String[] params) throws Exception {
        ...
        if (success) {
            ...
            //Method method = clazz.getMethod(fullClassName);
            //获取 set方法 填充值
...
//		        	Method method = pd.getWriteMethod();
	        		...
	        		String b = a.substring(3).toLowerCase();
	        		method.invoke(instance,map.get(b));
	        	}
	        }
	        Map<String, Object> nativeParams = new HashMap<String, Object>();
	        
	        //////////3
	        Field[] attributes = clazz.getFields();
	        for (Field attr : attributes) {
	        	nativeParams.put(attr.getName(), attr.get(attr.getName()));
	        }
	        //获取 get方法 值
	        for(Method field:ms){  
	        	...
	        	if(a.startsWith("get")){
	        		...
	        		Object c=method.invoke(instance);
		        	if (c instanceof String) {
		        		param.put(b, c.toString());
		        	}
	        	}
	        }  
