				...
				<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
					<div class="widget am-cf">
						<div class="widget-head am-cf">
							<div class="widget-title am-fl">接口日志</div>
						</div>
						<div class="widget-body am-fr">
							<div class="am-u-sm-12 am-u-md-3 am-u-lg-3">
							 ...
							 <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
								<form id="searchForm" action="${ctx}/slog/list1" method="post">
									<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
									<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
									<input id="orderBy" name="orderBy" type="hidden" value="${page.entity.orderBy}"/>
									<div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
										<div class="tagsinput">
											<c:if test="${not empty page.entity.requestUri}"><span class="tags"><input type="hidden" name="requestUri" value="${page.entity.requestUri}" />请求地址=${page.entity.requestUri} <a href="javascript:;" onclick="$(this).parent().remove()">x</a></span></c:if>
                                                <span class="am-select am-input-group-sm">
                                                     <input type="text" class="am-select-input" autocomplete="off" style="border: none;"
															placeholder="关键字" am-data='[{"field":"requestUri","desc":"请求地址","type":"string"}]'>
										...
										<c:forEach items="${page.list}" var="slog" varStatus="status">
											<tr>
												...
												<td title="${slog.requestUri}">
													<c:choose>
														<c:when test="${fn:length(slog.requestUri)>50}">
															<c:out value="${fn:substring(slog.requestUri, 0, 40)}..." />
														</c:when>
														<c:otherwise>
